...
while True:
    if search_id in product_ids:
        ...
        menu_choice = input("please type in display to display products, buy to buy products. Type in exit and enter to exit ")
        
        if menu_choice == "display":
            print(product_ids[index],product_names[index],product_prices[index],product_stock[index])
